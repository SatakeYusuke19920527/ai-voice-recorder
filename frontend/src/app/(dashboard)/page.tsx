...
export default function VoiceRecording() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col">
      <Card className="flex min-h-0 flex-1 flex-col items-center justify-center gap-8 border-muted/60 bg-background/80 px-6 py-10 shadow-lg">
            ...
            {meterLevels.map((level, index) => (
              <div
                ...
                className={`w-1.5 rounded-full transition-all duration-75 ${
                  isRecording ? 'bg-red-500/80' : 'bg-muted-foreground/30'
                }`}
                style={{
